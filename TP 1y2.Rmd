...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
# ----------------------------
# 1) Cargar shapefile y validar geometría
# ----------------------------
...
# ----------------------------
# 2) Merge con salario promedio por depto
# ----------------------------
# dept_promedio debe tener columnas: codigo_departamento_indec, salario_promedio_depto
